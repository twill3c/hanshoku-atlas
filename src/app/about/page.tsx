  ...
  return (
    <main>
      ...
      <section className="panel verdict fail">
        ...
        <p>
          <strong>対照は作り直した。それでも通らなかった。</strong>
          2c が退化していたので、<strong>「青の増加は青に固有か」という別の問い</strong>を
          測定前に宣言して測った(2c&apos;)。結果は
          <strong>a(対 赤系)通過 / b(対 有彩色全体)不通過</strong>。
          赤は同じ窓で減っているので色相には特異的だが、
          <strong>有彩色の面積比全体も青とほぼ同じだけ増えている</strong> ——
          「新しい青が入った」のか「彩色が増えて中身が青だった」のかを、この標本は分けられない。
        </p>
        <p>
